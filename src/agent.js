...
const Articles = {
  all: page =>
    requests.set(`http://52.78.116.176:9200/brandshop-*/_search?pretty&size=50`),
  ...
  byCategory: (id, page) =>
    requests.set(`http://52.78.116.176:9200/brandshop-*/_search?pretty&size=50&q=category_addtional:${id}`),
