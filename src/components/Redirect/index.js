  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        {
          this.props.params.id === "terms-privacy" ? (
            <div className="inner">
              <nav className="tab-terms">
                <a href="/#/redirect/terms-service" className="btn-tab">서비스 약관</a>
                <a href="/#/redirect/terms-privacy" className="btn-tab active">개인정보처리방침</a>
              </nav>
          ...
          - 전자상거래에서의 계약.청약철회, 대금결제, 재화 등 공급기록 : 5년</p>
            ...
            (<div className="inner">
              <nav className="tab-terms">
                <a href="/#/redirect/terms-service" className="btn-tab active">서비스 약관</a>
                <a href="/#/redirect/terms-privacy" className="btn-tab">개인정보처리방침</a>
              </nav>
              <div className="cont-terms">
